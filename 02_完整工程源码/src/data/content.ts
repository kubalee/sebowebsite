...
].map(([slug, en, title, body, result], index) => ({ slug: `laidianla/${slug}`, en, title, body, result, image: asset(["v6/mobile-service.webp", "official/engineering-team.png", "editorial/energyos-lab.jpg", "editorial/platform-hero.jpg", "v6/mine-energy.webp", "v6/co-design.webp", "v6/logistics-mobile.webp", "v6/mobile-service.webp", "official/thunderbird-product.png", "v6/co-design.webp"][index]) }));
