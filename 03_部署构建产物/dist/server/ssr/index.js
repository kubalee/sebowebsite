...
var client_references_default = {
	"5027278754f9": async () => {
		const m = await import("./assets/V6Site-D1fVdcYX.js");
		return { get "V6Site"() {
			return m["V6Site"];
		} };
	},
	...
	"c2747888630f": async () => {
		const m = await import("./assets/link-DRLvG-em.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"c7fa5cfea253": async () => {
		const m = await import("./assets/error-boundary-CO5u0nNK.js");
		return {
			get "ErrorBoundary"() {
	...
	"da06f1d026a2": async () => {
		const m = await import("./assets/layout-segment-context-DkzB2RwI.js");
