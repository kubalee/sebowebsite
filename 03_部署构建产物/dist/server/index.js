globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/query-D2V9OaoK.js","assets/V6Site-j4BbOZJ8.js","assets/layout-segment-context-DjFvOLFz.js","assets/link-CknOW3JF.js","assets/router-CA0Z9DKG.js"];
...
function getDraftSecret() {
	return "84366dae-fe1f-404d-8c6f-1c73be83b662";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "c10c0c72-2b19-4f2f-9c71-bf75bf9ae0dc";
	}
};
...
async function handleStaticParamsEndpoint(request, options) {
	...
	try {
		return jsonResponse$1(await callAppPrerenderStaticParams({
		...
		return jsonResponse$1({ error: String(error) }, 500);
	}
}
async function handlePagesStaticPathsEndpoint(request, options) {
	...
	try {
		...
		return jsonResponse$1(await getStaticPaths({
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "c10c0c72-2b19-4f2f-9c71-bf75bf9ae0dc") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "c10c0c72-2b19-4f2f-9c71-bf75bf9ae0dc",
		rootBoundaryId
	});
}
/**
...
var V6Site = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'V6Site' is called on server");
}, "5027278754f9", "V6Site");
//#endregion
//#region app/page.tsx
...
function HomePage() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(V6Site, { route: "" });
}
...
async function generateMetadata$1() {
	...
	return {
		metadataBase: base,
		title: {
			default: "SEBO | Electricity, Free as Air.",
			template: "%s | SEBO"
		},
		...
		openGraph: {
			title: "SEBO | Electricity, Free as Air.",
			description: "High-power energy infrastructure for AI compute, heavy-duty mobility and mission-critical operations.",
			type: "website",
			locale: "zh_CN",
			...
			images: [{
				...
				width: 1200,
				height: 630,
				alt: "SEBO high-power energy infrastructure"
			}]
		},
		twitter: {
...
function RootLayout({ children }) {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("html", {
		lang: "zh-CN",
		children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("body", { children: [children, /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("script", {
...
function NotFoundPage() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", { children: "这个页面不存在，或内容尚未获准发布。" }),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "请通过主导航继续浏览解决方案、技术产品、典型应用与关于 SEBO。" }),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("form", {
				action: "/news",
				method: "get",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("label", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
					className: "sr-only",
					children: "搜索内容"
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("input", {
					name: "q",
					placeholder: "搜索新闻与工程知识"
...
var routeSet = new Set(publicRoutes);
var serviceStartRoutes = new Set(publicRoutes.filter((route) => route.startsWith("laidianla/") && route !== "laidianla/start").map((route) => `${route}/start`));
function isPublicRoute(route) {
	const bare = route.replace(/^en\/?/, "").replace(/^\/+|\/+$/g, "");
	return bare === "" || routeSet.has(bare) || serviceStartRoutes.has(bare) || bare.startsWith("cases/");
}
//#endregion
...
async function RoutedPage({ params }) {
	const { slug } = await params;
	const route = slug.join("/");
...
function robots() {
	return {
		...
		sitemap: "https://www.sebo.org.cn/sitemap.xml",
		host: "https://www.sebo.org.cn"
	};
}
//#endregion
...
function sitemap() {
	...
	const now = /* @__PURE__ */ new Date("2026-07-13T00:00:00+08:00");
	return ["", ...publicRoutes].filter((route) => !route.endsWith("/action") && !route.endsWith("/assessment") && !route.endsWith("/start") && !route.startsWith("contact/") && route !== "careers/apply").flatMap((route) => {
		const path = route ? `/${route}` : "";
		const changeFrequency = route.startsWith("news") || route.startsWith("insights") ? "weekly" : "monthly";
		const priority = route === "" ? 1 : route.split("/").length === 1 ? .9 : .7;
		return [{
			url: `${base}${path || "/"}`,
	"/assets/v6/team-office.webp",
	"/assets/v6/team-outdoor.webp",
	"/favicon.svg",
	"/file.svg",
	"/globe.svg",
	"/og.png",
...
var RATE_LIMIT_WINDOW_MS = 600 * 1e3;
var RATE_LIMIT_MAX_REQUESTS = 5;
var RATE_LIMIT_RETENTION_MS = 2880 * 60 * 1e3;
var leadSchemaReady;
...
function makeLeadNumber(date = /* @__PURE__ */ new Date()) {
	return `SEBO-${date.toISOString().slice(0, 10).replaceAll("-", "")}-${crypto.randomUUID().replaceAll("-", "").slice(0, 10).toUpperCase()}`;
}
function stringField(data, key, maxLength, issues, required = false) {
	const raw = data[key];
...
function validateLead(data) {
	...
	const message = stringField(data, "message", 4e3, issues);
...
async function ensureLeadSchema(db) {
	if (!leadSchemaReady) leadSchemaReady = db.batch([
...
async function applyRateLimit(request, db) {
	const now = Date.now();
	...
	const rateKey = await hashRateKey(`${clientAddress === "unknown" ? `ua:${userAgent}` : `ip:${clientAddress}`}:${windowStart}`);
	await db.prepare(`INSERT INTO lead_rate_limits (rate_key, window_start, request_count, updated_at)
      VALUES (?, ?, 1, CURRENT_TIMESTAMP)
      ON CONFLICT(rate_key) DO UPDATE SET
        request_count = request_count + 1,
        updated_at = CURRENT_TIMESTAMP`).bind(rateKey, windowStart).run();
	const row = await db.prepare("SELECT request_count FROM lead_rate_limits WHERE rate_key = ?").bind(rateKey).first();
...
async function handleLeadRequest(request, env, ctx) {
	...
	if (!request.headers.get("content-type")?.toLowerCase().includes("application/json")) return jsonResponse({
		ok: false,
		error: "json_required"
	}, 415);
	const declaredLength = Number(request.headers.get("content-length") || 0);
	if (Number.isFinite(declaredLength) && declaredLength > MAX_BODY_BYTES) return jsonResponse({
		ok: false,
		error: "payload_too_large"
	}, 413);
	const rawBody = await request.text();
	if (new TextEncoder().encode(rawBody).byteLength > MAX_BODY_BYTES) return jsonResponse({
		ok: false,
		error: "payload_too_large"
	}, 413);
	let data;
	...
	if (!data || typeof data !== "object" || Array.isArray(data)) return jsonResponse({
		ok: false,
		error: "invalid_payload"
	}, 400);
	const payload = data;
	if (typeof payload.website === "string" && payload.website.trim()) return jsonResponse({
		ok: true,
		id: makeLeadNumber()
	}, 201);
	...
	try {
		...
		if (!validation.value) return jsonResponse({
			ok: false,
      ...
      ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'new', ?)`).bind(leadNumber, lead.name, lead.company, lead.phone, lead.email, lead.interest, lead.contactType, lead.message, lead.locale, lead.mode, lead.source, lead.consent ? 1 : 0, lead.marketing ? 1 : 0, userAgent, createdAt).run();
		ctx.waitUntil(env.DB.prepare("DELETE FROM lead_rate_limits WHERE window_start < ?").bind(Date.now() - RATE_LIMIT_RETENTION_MS).run());
		return jsonResponse({
			ok: true,
			id: leadNumber,
			createdAt
...
var worker_entry_default = { async fetch(request, env, ctx) {
	const url = new URL(request.url);
	if (url.pathname === "/api/leads") return withSecurityHeaders(await handleLeadRequest(request, env, ctx));
	if (url.pathname === "/_vinext/image") return withSecurityHeaders(await handleImageOptimization(request, {
	...
	return withSecurityHeaders(await app_router_entry_default.fetch(request, env, ctx));
} };
//#endregion
